function RootCommentObject(commentAPIObject) {
  ...
  this.profilePictureUrl = getMeta("staticResourcePath") +
  ...
  this.showingReplies = false; //by default, not showing replies
...
//update some fields with a new commentAPIObject
RootCommentObject.prototype.update = function(commentAPIObject) {
  this.username = commentAPIObject.username;
  this.timestamp = translateDateTime(commentAPIObject.date);
  this.bodyText = commentAPIObject.text;
  this.up = commentAPIObject.like;
  this.dn = commentAPIObject.dislike;
  this.replyCount = commentAPIObject.count;
  if (this.showingReplies) { //already fetched replies, fetch again
...
//this should work like a "refresh"
